...
def generate_objective_text(df_raw: pd.DataFrame) -> str:
    """
    解析 CSV 原始資料，編織生成包含 Palmer 十字齒列、分象限位點矩陣與排序後 Furcation 的標準 Objective 病歷文字。
    """
    ...
    output_lines = [
        generate_cross_dentition(missing_teeth),
        "",
        " 2. Oral hygiene: ______; generalized gingival inflammation with plaque and calculus deposition.",
        "",
        format_detailed_pd_section(df_raw, missing_teeth, threshold=5),
        "",
